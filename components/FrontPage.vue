            ...
            <!-- <header class="container flex items-center justify-between h-16 px-4 mx-auto rounded dark:bg-gray-900">
                <a rel="noopener noreferrer" href="#" aria-label="Homepage">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32"
                        class="w-6 h-6 dark:text-indigo-400">
                        <path
                ...
                <div class="items-center hidden space-x-8 lg:flex">
                    ...
                    <button class="px-4 py-2 rounded-md dark:bg-indigo-400 dark:text-gray-900">Sign up</button>
                </div>
                ...
                <div class="container mx-auto space-y-16">
                    <section class="grid gap-6 text-center lg:grid-cols-2 xl:grid-cols-5">
                        <div class="w-full p-6 rounded-md sm:p-16 xl:col-span-2 dark:bg-gray-900">
                            <span class="block mb-2 dark:text-indigo-400">Mamba design system</span>
                            <h1 class="text-5xl font-extrabold dark:text-gray-50">Build it with Mamba</h1>
                            <p class="my-8">
                                <span class="font-medium dark:text-gray-50">Modular and versatile.</span>The ultimate
                                design toolkit for savvy technology startups.
                            </p>
                            <form novalidate action=""
                                ...
                                <div>
                                    ...
                                    <input id="name" type="text" placeholder="Your name"
                                        class="w-full rounded-md focus:ring focus:ring-indigo-400 dark:border-gray-700">
                                </div>
                                <div>
                                ...
                                <button
                                    class="w-full py-2 font-semibold rounded dark:bg-indigo-400 dark:text-gray-900">Join
                                    the waitlist</button>
                            </form>
                        </div>
                    ...
                    <section>
                        <span
                            class="block mb-2 text-xs font-medium tracking-widest uppercase lg:text-center dark:text-indigo-400">How
                            it works</span>
                        ...
                        <div class="grid gap-6 my-16 lg:grid-cols-3">
                            <div class="flex flex-col p-8 space-y-4 rounded-md dark:bg-gray-900">
                                <div
                                    class="flex items-center justify-center flex-shrink-0 w-12 h-12 text-xl font-bold rounded-full dark:bg-indigo-400 dark:text-gray-900">
                                    1</div>
                    ...
                    <section class="grid gap-6 lg:grid-cols-2">
                        ...
                        <div
                            ...
                            <blockquote class="max-w-lg text-lg italic font-medium text-center">"Et, dignissimos
                                obcaecati. Recusandae praesentium doloribus vitae? Rem unde atque mollitia!"
                            </blockquote>
                        ...
                        <div class="p-8 space-y-8 rounded-md lg:col-span-full lg:py-12 dark:bg-gray-900">
                            ...
                            <p class="dark:text-gray-400">Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                                Nesciunt facilis quod accusantium beatae cum nam adipisci reiciendis omnis possimus
                                error quo animi voluptas magni, at incidunt. Nulla ex at ullam corporis quidem adipisci
                                vitae, perferendis dolorem libero minus atque tenetur enim pariatur cupiditate commodi
                                in beatae, ipsa eligendi? Quis, saepe.</p>
                        </div>
                    </section>
                    <section>
                        <div class="grid gap-6 lg:grid-cols-3">
                            <div class="overflow-hidden rounded lg:flex lg:col-span-3">
                                ...
                                <div class="p-6 space-y-6 lg:p-8 md:flex md:flex-col dark:bg-gray-900">
                                    <span
                                        class="self-start px-3 py-1 text-sm rounded-full dark:bg-indigo-400 dark:text-gray-900">Business</span>
